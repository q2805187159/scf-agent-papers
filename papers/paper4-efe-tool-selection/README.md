...
The evidence pack summary intentionally marks `paper4_ready` as `false`; it is for manuscript evidence development, not a submission-ready or peer-reviewed claim.
